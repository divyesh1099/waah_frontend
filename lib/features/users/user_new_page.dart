...
FutureProvider.autoDispose<List<RoleInfo>>((ref) async {
  ...
  return api.listRoles(tenantId: tenantId); // List<RoleInfo>
});
...
class UserCreatePage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<UserCreatePage> createState() =>
      _UserCreatePageState();
}

class _UserCreatePageState
    extends ConsumerState<UserCreatePage> {
  ...
  // we'll collect role codes ("CASHIER", "WAITER", etc.)
